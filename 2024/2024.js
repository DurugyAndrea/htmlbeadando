$(document).ready(function () {
    ...
    }).on('afterChange', function (event, slick, currentSlide) { //afterchange: slider változása
       // Leírás frissítése a jelenlegi diának megfelelően
       $('#slider-description').text(descriptions[currentSlide]); //a slide indexéhez köti a paragrafus indexét
    });
